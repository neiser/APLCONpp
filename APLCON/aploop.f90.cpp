...
/* Subroutine */
int aplcon_(integer *nvar, integer *mcst) {
...
/* Subroutine */
int aploop_(doublereal *x, doublereal *vx, doublereal *f,
            integer *iret) {
...
/* Subroutine */
int iploop_(doublereal *x, doublereal *vx, doublereal *f,
...
/* Subroutine */
int asteps_(doublereal *x, doublereal *vx, doublereal *st) {
    /* System generated locals */
    integer i__1, i__2;
...
/* Subroutine */
int anumde_(doublereal *x, doublereal *f, doublereal *a,
...
/* Subroutine */
int aniter_(doublereal *x, doublereal *vx, doublereal *f,
...
/* Subroutine */
int addtox_(doublereal *x, doublereal *xs, doublereal *dx,
            doublereal *xp) {
    /* System generated locals */
    integer i__1;
...
/* Subroutine */
int acopxv_(doublereal *x, doublereal *vx, doublereal *dx,
...
/* Subroutine */
int chndpv_(real *chi2, integer *nd, real *pval) {
...
/* Subroutine */
int adummy_0_(int n__, doublereal *arg, integer *i__, doublereal *step) {
...
/* Subroutine */
int apdeps_(doublereal *arg) {
    return adummy_0_(2, arg, (integer *)0, (doublereal *)0);
}

/* Subroutine */
int apstep_(integer *i__, doublereal *step) {
    return adummy_0_(8, (doublereal *)0, i__, step);
}

/* Subroutine */
int apoiss_(integer *i__) {
    return adummy_0_(12, (doublereal *)0, i__, (doublereal*)0);
}

/* Subroutine */
int apstat_(doublereal *fopt, integer *nfun, integer *niter) {
    /*     __________________________________________________________________ */
