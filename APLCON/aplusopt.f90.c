/* aplusopt.f90.F -- translated by f2c (version 12.02.01).
...
/* Subroutine */ int adummy_0_(int n__, integer *lunp, integer *jpr, 
	doublereal *arg, integer *it, integer *i__, doublereal *step, 
	doublereal *xlow, doublereal *xhig, integer *nbinom, doublereal *pow)
{
...
/*     Do nothing...no printing anymore */
    switch(n__) {
	case 1: goto L_aprint;
	case 2: goto L_apdeps;
	case 3: goto L_apepschi;
	case 4: goto L_apderf;
	case 5: goto L_apderu;
	case 6: goto L_apdlow;
	case 7: goto L_apiter;
	case 8: goto L_apstep;
	case 9: goto L_apfix;
	case 10: goto L_aplimt;
	case 11: goto L_aptrin;
	case 12: goto L_apoiss;
	case 13: goto L_abinom;
	case 14: goto L_aplogn;
	case 15: goto L_apsqrt;
	case 16: goto L_apower;
	case 17: goto L_aposit;
	}
...
{
    return adummy_0_(0, (integer *)0, (integer *)0, (doublereal *)0, (integer 
	    *)0, (integer *)0, (doublereal *)0, (doublereal *)0, (doublereal *
	    )0, (integer *)0, (doublereal *)0);
    }

/* Subroutine */ int aprint_(integer *lunp, integer *jpr)
{
    return adummy_0_(1, lunp, jpr, (doublereal *)0, (integer *)0, (integer *)
	    0, (doublereal *)0, (doublereal *)0, (doublereal *)0, (integer *)
	    0, (doublereal *)0);
    }
...
{
    return adummy_0_(8, (integer *)0, (integer *)0, (doublereal *)0, (integer 
	    *)0, i__, step, (doublereal *)0, (doublereal *)0, (integer *)0, (
	    doublereal *)0);
    }

/* Subroutine */ int apfix_(integer *i__)
{
    return adummy_0_(9, (integer *)0, (integer *)0, (doublereal *)0, (integer 
	    *)0, i__, (doublereal *)0, (doublereal *)0, (doublereal *)0, (
	    integer *)0, (doublereal *)0);
    }
...
/* Subroutine */ int aptrin_(integer *i__)
{
    return adummy_0_(11, (integer *)0, (integer *)0, (doublereal *)0, (
	    integer *)0, i__, (doublereal *)0, (doublereal *)0, (doublereal *)
	    0, (integer *)0, (doublereal *)0);
    }
